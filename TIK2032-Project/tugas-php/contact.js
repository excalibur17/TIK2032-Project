...
document.addEventListener('DOMContentLoaded', function() {
    ...
    toggleButton.addEventListener('click', function() {
        ...
        // Memanggil fungsi untuk menggerakkan tombol saat diklik
        moveButton();
    });

    // Fungsi untuk menggerakkan tombol saat diklik
    function moveButton() {
        const currentPosition = toggleButton.getBoundingClientRect().top;
        toggleButton.style.transform = `translateY(${currentPosition + 10}px)`;
